...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "rounded-base font-heading focus-visible:ring-ring data-[state=active]:bg-background data-[state=active]:text-main-foreground data-[state=active]:border-border inline-flex items-center justify-center gap-1.5 border-2 border-transparent px-2 py-1 text-sm whitespace-nowrap ring-offset-white transition-all focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
        className
      )}
      {...props}
    />
