      ...
      <div className='w-fit'>
        <div className='flex flex-col items-center text-center md:items-start md:text-start'>
          <h1 className='w-full max-w-md text-6xl font-bold md:text-7xl xl:max-w-xl xl:text-8xl'>
            One Page.
            <span className='to-primary bg-gradient-to-r from-[#D247BF] bg-clip-text px-2 text-transparent md:px-0'>
              {" "}
              Many{" "}
            </span>
            Links.
          </h1>
          <h2 className='text-accent-foreground/70 my-6 w-full max-w-md px-4 text-xl md:px-0 md:text-2xl xl:max-w-xl xl:text-3xl'>
            A smarter, simpler way to connect your audience with everything you
            do.
          </h2>
