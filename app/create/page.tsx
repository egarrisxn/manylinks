    ...
    <>
      ...
      <div className='lg:max-w-screen-3xl mx-auto grid grid-cols-1 px-2 lg:min-h-[88vh] lg:w-full lg:grid-cols-2 lg:px-0 2xl:grid-cols-12 2xl:px-4'>
        <section className='3xl:px-2 mx-auto flex min-h-[88vh] w-full flex-col items-center justify-center px-2 py-3 lg:h-[88vh] 2xl:col-span-5'>
          <div className='hide_scrollbar flex w-full flex-col gap-6 overflow-y-auto px-4 pt-[5vh] pb-[10vh] lg:pt-0 lg:pb-0'>
            <ProfileForm />
            <SocialLinksForm />
            <ExtraLinksForm />
            <BackgroundCard />
            <div className='grid w-full grid-cols-2 items-center justify-center gap-2 px-1 pb-2 md:gap-4'>
              <SampleData />
              <PublishPage />
            </div>
          </div>
